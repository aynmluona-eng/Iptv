...
files.forEach(file => {
  ...
  content = content.replace(/text-brand-light/g, 'text-gray-300'); 
  ...
  content = content.replace(/shadow-[a-z]+ shadow-[a-z]+\/[0-9]+/g, ''); 
  ...
  content = content.replace(/bg-gradient-to-b from-\[#0D111A\] to-transparent/g, 'bg-gradient-to-b from-dark to-transparent');
